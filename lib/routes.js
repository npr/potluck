...
app.get('/curator', mod_curator.index);
app.get('/v1/curator/themes', mod_curator.getThemes); 
app.get('/v1/curator/assets', mod_curator.getAssets); 
